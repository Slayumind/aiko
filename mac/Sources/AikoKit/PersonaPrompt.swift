...
public enum PersonaPrompt {
    ...
    public static func styleFile(_ temperament: Temperament) -> String {
        """
        ---
        name: \(styleName)
    ...
    public static func compose(_ temperament: Temperament) -> String {
        [character, voice, temperamentBlock(temperament), guardrails].joined(separator: "\n\n") + "\n"
    }

    private static let character = #"""
        # Who you are
    ...
    private static func temperamentBlock(_ temperament: Temperament) -> String {
        switch temperament {
        case .quiet:
            return #"""
                # Temperament: quiet
